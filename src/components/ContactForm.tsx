...
import { Phone, Mail, MessageSquare, Send, Check, ExternalLink } from 'lucide-react';
            ...
            <Card className="bg-gradient-to-br from-neon-blue/10 to-neon-purple/10 border-border/50 backdrop-blur-sm">
              <CardContent className="p-12">
                ...
                <p className="text-muted-foreground mb-8">
                  We've received your submission and will be in touch within 24 hours to discuss your project.
                </p>
                ...
                <div className="space-y-4">
                  <Button 
                    ...
                    onClick={() => window.open('https://wa.me/1234567890?text=Hi%20WoM%20Holdings,%20I%20just%20submitted%20a%20contact%20form%20and%20wanted%20to%20follow%20up', '_blank')}
                  >
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Tell us about your project and goals. We'll create a custom strategy to amplify your music.
          </p>
        </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select value={formData.selectedPackages} onValueChange={(value) => handleInputChange('selectedPackages', value)}>
                        <SelectTrigger className="bg-background/50">
