...
const ProcessTimeline = () => {
              ...
              {processSteps.map((step, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <Card
                      className={`group hover-lift hover-glow relative overflow-hidden bg-gradient-to-br ${getStepGradient(
                        index
                    ...
                    >
                      <CardContent className="p-6 text-center">
                        ...
                        {/* Step Number */}
                        <div
                          className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-[calc(-50%+10px)]
  ...
  shadow-[0_0_12px_rgba(139,92,246,0.8)] border-2  z-10"
                        >
                          {index + 1}
                        </div>
                    ...
                    <div
                      className={`hidden lg:block absolute left-1/2 transform -translate-x-1/2 w-4 h-4 bg-gradient-to-br from-neon-blue to-neon-purple rounded-full border-2 border-background ${
      ...
      <section className="bg-gradient-to-r from-neon-blue/10 to-neon-purple/10">
        <div className="container mx-auto py-20 ">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Specialized in music marketing with proven industry results
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Professional video production and graphic design
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Real-time analytics and optimization for maximum impact
                </p>
              </div>
            </div>
            ...
            <div className="mt-10 text-center">
              <p className="text-muted-foreground mb-4">
                Want to see how this process could work for your music?
              </p>
              <Button size="lg" asChild className="pill-button-primary">
                <Link to="/booking">Book a Free Strategy Call</Link>
              </Button>
            </div>
          </div>
      </section>
